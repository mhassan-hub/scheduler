...
export default function Appointment (props) {
  ...
  const { id, time, interview, onEdit, onDelete, onAdd, interviewers, bookInterview, deleteInterview } = props;
  ...
  return (
    ...
    <article className="appointment">
      ...
      {/* On edit, render form with inital values of the previous show component */}

      {mode === EDIT && 
      <Form 
      name={interview && interview.student}
      interviewers={interviewers}
      // form accepts interviewer as an id
